...
\subtitle{Machine Learning \\ In-Memory}
\author{Sylvan Brocard}
\subject{MIAI Label}
\affiliation{Campus Numérique in the Alps}

\coverimage{figures/puce-upmem.jpg} % Aspect ratio of 2:3 (portrait) recommended
